...
def set_need_name_list(_id):
    ...
    tag_dict = {
        ...
        15: ['神吐槽'],
        # 技术编程
        16: ['高可用架构', 'Linux爱好者', 'Python开发者', '稀土圈',
             '程序员的那些事', '极客范', 'Python程序员', '架构师',
             '电脑报', ' InfoQ', '好东西传送门'],
        # 创意科技
        17: ['36氪', '创见', '虎嗅网', '科技每日推送', '神秘的程序员们',
             'Zealer中国', '罗永浩'],
        # 金融理财
        18: ['简七理财', '力哥说理财', '清华财富', '格上理财', '和讯理财',
            '华尔街见闻', '互联网金融观察', '哈佛商业评论', '跑赢大盘的王者',
             '港股那点事', '21世纪经济报道', '股社区', '天天说钱', '揭幕者',
             '黄生看金融', '吴晓波频道', '钱眼', '央视财经', '基金圈',
             '南方基金微视界', '天天基金网', '天弘基金', '理财帮助'],
        # 生活心理
        19: ['壹心理', 'KnowYourself', '硬派健身', '丁香医生', '果壳网',
             '女人坊', '商务范', '时尚芭莎', '每天学点穿衣打扮', '健康之路',
             '海报网', '瑞丽网'],
        # 电影音乐
        20: ['电影天堂', '全球电影排行榜', '毒舌电影', '耳帝', '独立鱼电影',
             'Mtime时光网'],
        # 段子节操
        21 :['冷兔', '内涵段子', '煎蛋', '我们爱讲冷笑话', '卡娃微卡',
             '同道大叔', '冷笑话精选'],
    }
