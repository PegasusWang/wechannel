...
TAG_DICT = {
    ...
    16: ['高可用架构', 'Linux爱好者', 'Python开发者', '稀土圈', '伯乐在线',
         '极客范', 'Python程序员', '架构师', '编程派', '聊聊架构',
         'InfoQ', '好东西传送门', '机器之心', '并发编程网',
         '开源中国', 'caoz的梦呓', '前端大全', 'Linux中国',
         'MacTalk', '湾区日报', '技术最前线', 'DBAplus社群', '云栖社区',
         '嘀嗒嘀嗒'],
    # 创意科技
    17: ['互联网+', '36氪', '创见', '虎嗅网', '科技每日推送', '神秘的程序员们',
         '知乎日报', '麻省理工科技评论', '少数派', '商业价值', '电脑报',
         '小道消息', '网易科技', '搜狐科技', '创业家', '创投界'],
    # 金融理财
    18: ['简七理财', '力哥理财', '格上理财', '和讯理财', '金融八卦女', '码农投资',
         '华尔街见闻', '互联网金融观察', '哈佛商业评论', '跑赢大盘的王者',
         '港股那点事', '21世纪经济报道', '股社区', '天天说钱', '揭幕者',
         '黄生看金融', '吴晓波频道', '钱眼', '央视财经', '基金圈',
         '南方基金微视界', '天天基金网', '天弘基金', '定投十年赚十倍',
         '集思录', '越女读财'],
    # 生活心理
    19: ['KnowYourself', '视觉志', 'papi', '壹心理', '硬派健身', '丁香医生', '果壳网',
         '商务范', '时尚芭莎', '每天学点穿衣打扮', '咪蒙',
         '海报网', '瑞丽网', '简书', '奇葩说', '微精选', '水木文摘',
         '美丽说', '美美家族', '改变自己', 'bethebeauty'],
    # 电影音乐
    ...
    # 个人订阅
    22: ['阿尔法工场', '虎嗅网', '阿里技术', 'InfoQ', '迎刃', 'BigTiger', '九章算法',
         'DBAplus社群', '改变自己', '码农悟凡', 'caoz的梦呓', '猫男托比', 'MacTalk',
         '集思录', 'KnowYourself', '定投十年赚十倍', 'Linux爱好者', 'Linux中国', '架构师之路',
         'Python开发者', '聊聊架构', '51CTO博客', 'Python之美', '前端大全', '湾区日报',
         '编程派', 'Python程序员', '哈佛商业评论', '思特沃克', '云栖社区', '码农投资',
         '嘀嗒嘀嗒', 'BeTheBeauty', '程序人生', '高可用架构', '妄想型精分影评', '架构师',
         'TimYang'],
